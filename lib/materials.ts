...
export const materials: MaterialData[] = [
  ...
  },
  {
    ...
    swatches: [
      ...
      { id: "sw-wt041", code: "WT 041", name: "Plain Black", src: "/uploads/pvc-wt041-plain-black.jpg" },
      { id: "sw-wt112", code: "WT 112", name: "Dark Walnut", src: "/uploads/pvc-wt112-dark-walnut.jpg" },
      { id: "sw-wt115", code: "WT 115", name: "Charcoal", src: "/uploads/pvc-wt115-charcoal.jpg" },
      { id: "sw-wt114", code: "WT 114", name: "Light Grey", src: "/uploads/pvc-wt114-light-grey.jpg" },
      { id: "sw-wt130", code: "WT 130", name: "Oak Brown", src: "/uploads/pvc-wt130-oak-brown.jpg" },
      { id: "sw-wt164-gold", code: "WT 164", name: "Black Marble", src: "/uploads/pvc-wt164-black-marble-gold.jpg" },
      { id: "sw-wt082", code: "WT 082", name: "Cream", src: "/uploads/pvc-wt082-cream.jpg" },
      { id: "sw-wt061", code: "WT 061", name: "Light Brown", src: "/uploads/pvc-wt061-light-brown.jpg" },
    ],
